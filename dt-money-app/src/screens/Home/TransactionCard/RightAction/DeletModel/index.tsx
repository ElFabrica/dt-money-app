...
export const DeletModal: React.FC<Params> = (
    { 
        visible, 
        hideModal, 
                        ...
                        <TouchableWithoutFeedback onPress={(e) => e.stopPropagation()}>
                            <View className="m-5 bg-background-secondary rounded-[16] p-8 items-center shadow-lg w-[90%] h-[322] z-2">
                                ...
                                <View className="p-3 flex-1 border-b border-gray-300 items-center justify-center ">
                                    <Text className="text-gray-500 text-lg leading-8">Tem certeza que deseja deletar esta transação? Esta ação não
                                        pode ser desfeita</Text>
                                </View>
